const translation = {
  ...
  menus: {
    ...
    apps: 'Студія',
    plugins: 'Плагіни',
    pluginsTips: 'Інтегруйте сторонні плаг��ни або створіть AI-сумісні плагіни.',
    datasets: 'Знання',
  ...
  account: {
    ...
    deleteTip: 'Видалення вашого облікового запису призведе до остаточного видалення всіх ваших даних, і їх неможливо буде відн��вити.',
  ...
  members: {
    ...
    builderTip: '��оже створювати та редагувати власні програми',
  },
  integrations: {
  ...
  modelProvider: {
    ...
    embeddingModel: {
      ...
      tip: 'Встановіть модель за замовчуванням для обробки вбудовування документа у Знання, як пошук, так і імпорт Знань використовують цю модель вбудовування для векторизації. Перемикання призведе до невідповідності розмірності вектора ��іж імпортованими Знаннями та запитанням, що призведе до збою пошуку. Щоб уникнути збоїв пошуку, не перемикайте цю модель без підстав.',
    ...
    loadBalancingLeastKeyWarning: 'Щоб увімкнути балансування навантаження, має бути ввімкнено щона��менше 2 клавіші.',
  ...
  apiBasedExtension: {
    ...
    selector: {
      ...
      placeholder: 'Виберіть API ро��ширення',
