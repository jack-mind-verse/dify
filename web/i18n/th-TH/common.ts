const translation = {
  ...
  account: {
    ...
    delete: 'ลบบัญชี',
    deleteTip: 'การลบบัญชีของคุณจะเป็นการลบข้อมูลทั้งหมดของคุณอย่างถาวรและไม่สามารถกู���คืนได้',
  ...
  members: {
    ...
    inviteTeamMember: 'เพิ่มสมาชิกใน��ีม',
  ...
  modelProvider: {
    ...
    systemReasoningModel: {
      ...
      tip: 'ตั้งค่าโมเดลการอนุมานเริ่มต้นที่จะใช้สําหรับกา���สร้างแอปพลิเคชัน ตลอดจนคุณลักษณะต่างๆ เช่น การสร้างชื่อบทสนทนาและคําแนะนําคําถามถัดไปจะใช้โมเดลการอนุมานเริ่มต้นด้วย',
    },
    embeddingModel: {
      key: 'โมเดลการฝัง',
      ...
      required: 'จําเป็นต้องมีแบบ���ําลองการฝัง',
    },
    speechToTextModel: {
    ...
    noModelFound: 'ไ��่พบแบบจําลองสําหรับ {{model}}',
    models: 'รุ่น',
    ...
    card: {
      ...
      tip: 'ลําดับความสําคัญจะได้รับจากโควต้าที่จ่าย โควต้าทดลองใช้จะถูกใช้หลังจากโ���วต้าที่จ่ายหมด',
    },
    item: {
  ...
  appModes: {
    completionApp: 'เครื่องกําเนิดข้อค���าม',
    chatApp: 'แอพแชท',
  },
  datasetMenus: {
    documents: 'เอกสาร',
