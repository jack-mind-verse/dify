const translation = {
  ...
  model: {
    params: {
      ...
      frequency_penaltyTip:
        'नए टोकनों को दंडित क���ने की मात्रा इस पर आधारित है कि वे अब तक के पाठ में कितनी बार दिखाई दिए हैं।\nयह मॉडल की संभावना को एक ही पंक्ति को शब्दशः दोहराने की संभावना को कम करता है।',
      ...
      maxTokenSettingTip:
        'आपकी अधिकतम टोकन सेटिंग उच्च है, जो प्रॉम्प्ट, क्वेरी और डे���ा के लिए जगह को सीमित कर सकती है। इसे 2/3 से नीचे सेट करने पर विचार करें।',
  ...
  members: {
    ...
    setEditor: 'संपाद�� के रूप में सेट करें',
  ...
  provider: {
    ...
    saveFailed: 'एपीआई कुंजी सहेजना विफल र���ा',
    ...
    openaiHosted: {
      ...
      desc: 'Dify द्वारा प्रदान की गई OpenAI होस्टिंग सेवा आपको GPT-3.5 जैसे मॉडल का उपयोग करने की अनुमति देती है। आपके परीक्षण कोटा के समाप्त होने से प���ले, आपको अन्य मॉडल प्रदाताओं को सेट करने की आवश्यकता है।',
      callTimes: 'कॉल बार',
  ...
  modelProvider: {
    ...
    systemModelSettingsLink: 'स���स्टम मॉडल सेट करना क्यों आवश्यक है?',
    ...
    item: {
      deleteDesc:
        '{{modelName}} क�� सिस्टम तर्क मॉडल के रूप में उपयोग किया जा रहा है। हटाने के बाद कुछ कार्य उपलब्ध नहीं होंगे। कृपया पुष्टि करें।',
    ...
    providerManagedDescription:
      'मॉडल प्रदाता द्वारा प्रदान की गई एकल सेट की साख का उपयोग ���रें।',
  ...
  apiBasedExtension: {
    ...
    selector: {
      ...
      placeholder: 'कृपया एपीआई एक्सट��ंशन चुनें',
