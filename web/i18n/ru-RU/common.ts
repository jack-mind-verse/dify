const translation = {
  ...
  model: {
    params: {
      ...
      top_p: 'Top P',
      top_pTip:
        'Контролирует разнообразие с помощью ядерной выборки: 0,5 означает, что рассмат��ивается половина всех вариантов, взвешенных по вероятности.',
  ...
  members: {
    ...
    inviteTeamMemberTip: 'Они могут получить доступ к данным вашей команды сразу п��сле входа в систему.',
    email: 'Электронная почта',
