const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'سرویس میزبانی OpenAI ارائه شده توسط Dify به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهن��گان مدل را تنظیم کنید.',
  ...
  modelProvider: {
    ...
    item: {
      deleteDesc: '{{modelName}} به عنوان مدل‌های استدلال سیستم استفاده می‌شوند. برخی از عملکردها پس از حذف در د��ترس نخواهند بود. لطفاً تأیید کنید.',
    ...
    loadPresets: 'با��گیری تنظیمات از پیش تعیین شده',
    ...
    loadBalancingInfo: 'به طور پیش‌فرض، تعادل بار از استراتژی Round-robin استفاده می‌کند. اگر محدودیت نرخ فعال شود، یک دوره خنک شدن 1 دقیق��‌ای اعمال خواهد شد.',
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError: 'خوان��ن تصویر ناموفق بود، لطفاً دوباره تلاش کنید.',
